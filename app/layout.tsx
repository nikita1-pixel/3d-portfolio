...
export const metadata: Metadata = {
  title: "Nirmala Choudhary — Frontend Engineer & Full Stack Developer",
  description:
    "Portfolio  Nirmala Choudhary — Frontend Engineer / Full Stack Developer. Experince web 3D con Next.js y React Three Fiber.",
  authors: [{ name: "Nirmala Choudhary" }],
  openGraph: {
    title: "Nirmala Choudhary — Frontend Engineer & Full Stack Developer",
    description:
